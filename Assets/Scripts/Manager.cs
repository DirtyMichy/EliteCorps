...
public class Manager : MonoBehaviour
{
	...
	//int BOSSMISSION = 5;
	int maxKills = 64;
	int startedCampaign = 0;
	//0 means no saveFile exists
	int endlessModeRNGBoss = 666;
	//Random bosses spawn in endlessMode, 666 means no Boss, 0 means Boss01,...
	public int[] playerChoice;
	//Chosen Character by Player 0 = Character01

	public int playerCount = 0;
	//PlayerCounter 0 = no active Player
	public int missionMode = 0;
	//0 = None, 1 = Kill Enemies, 2 = Survive x seconds, 3 = Kill Ojectives, 4 = escort
	public int gameMode = 0;
	//0 = None, 1 = Mission, 2 = Survive
	public int currentMainMenuSelection = 0;
	//0 = StoryMode, 1 = Survival, 2 = Exit
	public int currentMissionSelection = 0;
	public int kills = 0, seconds = 300, objectiveKills = 0;
	//For GameModes
	...
	//[0] = E1M1, 0 = Disabled, 1 = Enabled, 2 = Won
	public int endlessProgress;
	//Every x Mission the enemytypes get mixed again

	public static Manager current;
	//A public static reference to itself (make's it visible to other objects without a reference)
	...
	public GUIText[] ingameScoreGUIText;
	//The score text
	public GUIText[] highScoreGUIText;
	//The high score text
	public GUIText[] playerActiveText;
	public GUIText[] mainMenuGuiText;
	//Start, Options, Exit...
	public GUIText objectiveText;
